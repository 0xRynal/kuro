                ...
                try {
                    ...
                    if (interaction.customId === 'shop_cles' || interaction.customId === 'shop_objets') {
                        ...
                        await interaction.update({ 
                            ...
                            if (err.code !== 10008) {
                                console.error('Erreur lors de l\'update interaction shop:', err);
                            }
                        });
                        return;
                    }
                    ...
                    if (interaction.customId === 'shop_back') {
                        try {
                            ...
                            await interaction.update({ 
                                ...
                                if (err.code !== 10008) {
                                    console.error('Erreur lors de l\'update interaction shop retour:', err);
                                }
                            });
                    ...
                    if (interaction.customId.startsWith('buy_') && currentCategory) {
                        ...
                        await interaction.update({ 
                            ...
                            if (err.code !== 10008) {
                                console.error('Erreur lors de l\'update interaction shop achat:', err);
                            }
                        });
