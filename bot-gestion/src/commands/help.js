    ...
    await message.reply({
        embeds: [{
            ...
            fields: [
                ...
                { name: 'Warn', value: `\`${p}warn @user [raison]\` \`${p}sanctions @user\` \`${p}warnlist <userID>\``, inline: false },
                ...
                { name: 'Config', value: `\`${p}set <log|fullperm|highrank> <id>\` \`${p}setperm @role <perm>\` \`${p}rperm @role <perm>\``, inline: false },
            ],
